#+BEGIN_COMMENT
.. title: A simple introduction of lengyueyang's spacemacs configration
.. slug: 
...
#+DATE: 2017-03-26
#+LAYOUT: post
#+TAGS: Spaceacs, lengyueyang, Configuration
#+CATEGORIES: EMACS
...
I downloads some snippets from web like [[https://github.com/AndreaCrotti/yasnippet-snippets][yasnippet-snippets]] and [[https://github.com/howardabrams/dot-files][dot-file]] then I defined some snippets of mine.
